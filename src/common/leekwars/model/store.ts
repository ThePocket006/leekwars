import { Chat, ChatMessage, ChatType } from '@/common/leekwars/model/chat'
import { Farmer } from '@/common/leekwars/model/farmer'
import { ItemType } from '@/common/leekwars/model/item'
import { LeekWars } from '@/common/leekwars/model/leekwars'
import { Notification, NotificationType } from '@/common/leekwars/model/notification'
		...
		notification(state: LeekWarsState, data: { id: number, type: number, date: number, parameters: any[], new: boolean }) {
			if (data.new) {
				...
				if (state.farmer && data.type === NotificationType.TROPHY_UNLOCKED) {
					...
					import("@/common/leekwars/model/trophies").then(module => {
			...
			import("@/common/leekwars/model/notification-builder").then(module => {
