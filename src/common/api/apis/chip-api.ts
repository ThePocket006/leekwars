...
export const ChipApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async chipGetAllGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
...
export const ChipApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async chipGetAllGet(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
...
export class ChipApi extends BaseAPI {
     ...
     * @memberof ChipApi
     */
    public async chipGetAllGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
